...
- [ ] Demonstrated use of a string (more than just a string "literal") in the lab. ___/2.5
...
1.  Demonstrate one functioning ```string``` (more than just a string "literal") to your professor.
